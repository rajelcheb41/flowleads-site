...
$runLog = Join-Path $logDir "weekly-audit-run-$stamp.txt"

Set-Location $root

"=== weekly-audit run $stamp ===" | Out-File -FilePath $runLog -Encoding utf8

$promptPath = Join-Path $root "automation\weekly-audit-prompt.md"
